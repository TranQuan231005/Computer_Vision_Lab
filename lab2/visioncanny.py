...
# ================== BUOC 1: Gaussian Blur ==================
blurred = cv2.GaussianBlur(gray, (5, 5), sigmaX=1.4)

# ================== BUOC 2: Tinh Gradient (Sobel) ==================
...
# ================== BUOC 3: Non-Maximum Suppression ==================
...
# ================== BUOC 4: Hysteresis Thresholding ==================
...
plt.tight_layout()
plt.show()
print('Da chay xong toan bo 4 buoc.')